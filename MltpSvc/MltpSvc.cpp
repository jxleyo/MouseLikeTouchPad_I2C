...
BEGIN_MESSAGE_MAP(CMltpSvcApp, CWinApp)
...
BOOL CMltpSvcApp::InitInstance()
{
	//只允许一个实例运行
	HANDLE hMutex = CreateMutex(NULL, TRUE, _T("OnlyMltpSvcTag"));
	if (hMutex)
	{
	...
	// TODO: 应适当修改该字符串，
	// 例如修改为公司或组织名
	SetRegistryKey(_T("MouseLikeTouchPad"));//注册表项
